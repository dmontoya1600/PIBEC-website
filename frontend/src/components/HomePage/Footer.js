...
function Footer({ isLoaded }){
  ...
  return (
    <div id='footer' className='homepage__footer'>
        <form className={"footer__contact__us scroll-transition-fade " +(isVisible ? 'nothing' : 'below-viewport')}  ref={ref}>
        ...
        <div className={"footer__tag scroll-transition-fade " +(isVisible ? 'nothing' : 'below-viewport')} >
