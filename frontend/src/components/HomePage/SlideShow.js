  ...
  return (
    <div className={`slideshow__component ${authSlide}`}>
      ...
      : null}
        ...
        <div className='slide__phone'> <p>¡Conferencia de misiones esta noche a las 6 pm no se lo pierda!</p> </div>
        <div className='slide__message'>
          <img src={logo}/>

           {/* Primera Iglesia Bautista El Calvario */}
        </div>
        <a onClick={() => removehash(history)}href='#contact__link' className='slide__contact'>CONTACTANOS</a>
